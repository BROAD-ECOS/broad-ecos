package br.ufjf.nenc.eenrollment.config;

import br.ufjf.nenc.eenrollment.provider.CurrentCourseProvider;
import br.ufjf.nenc.eenrollment.provider.CurrentUserProvider;
import br.ufjf.nenc.eenrollment.resolver.ContextArgumentResolver;
import br.ufjf.nenc.eenrollment.resolver.CurrentCourseArgumentResolver;
import br.ufjf.nenc.eenrollment.resolver.CurrentUserArgumentResolver;
