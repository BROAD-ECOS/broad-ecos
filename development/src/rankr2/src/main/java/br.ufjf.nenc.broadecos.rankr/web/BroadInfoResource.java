...
public class BroadInfoResource {
    ...
    @RequestMapping(path = "/course-info", method = PUT)
    public Course putCourseInfo(@RequestBody Course course, Context context){
        return broadService.retrieveOrCreate(context.getPlatform(), course).getCourse();
    }
