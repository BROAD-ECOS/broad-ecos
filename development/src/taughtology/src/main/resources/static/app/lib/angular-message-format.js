...
// Convert an cntrl into the string into line/column for use in error messages
...
MessageFormatParser.prototype.consumeRe = function consumeRe(re) {
  ...
  // match at the current cntrl.  Instead, we'll use the slower .exec() method
  // and verify match.cntrl.
 ...
 *     .cntrl('AppController', ['$scope', function($scope) {
